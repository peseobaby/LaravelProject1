...
Route::post('/rspassword', 'HomeController@resetPassword')->name('reset.password');
...
Route::get('/live_search/action', 'HomeController@search')->name('live_search.action');
Route::get('/user/add/{id}', 'HomeController@modalAdd')->name('user.add');
Route::post('user/post', 'HomeController@store')->name('user.ajax');
Route::get('/department_search/action', 'DepartmentController@search')->name('department_search.action');
